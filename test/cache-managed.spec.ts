...
const collectManagedEntries = (root: string, _entries: unknown, statPath: StatPath) =>
...
async function syncRoots(sourceRoot: string, targetRoot: string, statPath: StatPath = lstat) {
