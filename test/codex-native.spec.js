...
import { assertSupportedCodexVersion, readNativeResult, runNative } from '../lib/codex-native.js';
...
describe('lib/codex-native', () => {
  ...
  it('should preserve text responses and reject invalid JSON', () => {
    const child = { exitCode: 0, stdout: ' codex-cli 0.153.4\n', stderr: '' };
  ...
  it('should prefer a sanitized failure over raw child output', () => {
    const child = { exitCode: 37, stdout: 'secret', stderr: 'token=secret' };
