...
The agent needs file and command execution tools and Node. Codex Tools provisions its supported CLI
for installation and refresh; npm sources also require npm.
