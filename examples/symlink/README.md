...
Linked marketplace planning, preservation, self-installation, and rejection checks.
...
bun ../.fixtures/symlink.js setup "$root"
...
bun ../.fixtures/symlink.js preserved "$root"
