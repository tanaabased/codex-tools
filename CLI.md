...
See [marketplace ownership](./ADVANCED.md#marketplace-ownership) for catalog selection and preservation.
...
See [npm acquisition](./ADVANCED.md#npm-acquisition) for registry configuration and package pinning.
...
Review and commit the source manifest edit. See [refresh and recovery](./ADVANCED.md#refresh-and-recovery)
for partial effects and payload restrictions.
...
See [cache ownership](./ADVANCED.md#cache-ownership) for managed paths, exclusions, and raw-target creation.
The executable [cache scenarios](https://github.com/tanaabased/codex-tools/tree/main/examples/cache)
cover drift, synchronization, and convergence.
